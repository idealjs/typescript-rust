...
- **conformance 页12（#1201-1300）一次过**：64P/0S/36ad/**0F**（computedPropertyNames 全家/superCallBeforeThis 窗口）；页13（#1301-1400）一次过：63P/3S/34ad/**0F**（computedPropertyNames 续/decorator.es6/destructuring 窗口）。
