...
- **conformance 页12（#1201-1300）一次过**：64P/0S/36ad/**0F**（computedPropertyNames 全家/superCallBeforeThis 窗口）；页13（#1301-1400）一次过：63P/3S/34ad/**0F**（computedPropertyNames 续/decorator.es6/destructuring 窗口）；页14（#1401-1500）一次过：53P/11S/36ad/**0F**（destructuring 续/iterableArrayPattern 窗口）；页15（#1501-1600）一次过：44P/4S/52ad/**0F**（iterableArrayPattern 续/for-of 全家/FunctionDeclaration_es6 窗口）。
