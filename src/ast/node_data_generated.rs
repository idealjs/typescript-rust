// Code generated by _scripts/generate-rust-ast.ts. DO NOT EDIT.

//! Generated AST node data types.
//!
//! This file is automatically generated from `_scripts/ast.json`.
...
/// Token flags for lexical tokens.
...
/// Kind-specific data for an AST node.
///
/// In Go this is the `nodeData` interface with hundreds of implementations.
/// In Rust we use an enum so the compiler can verify exhaustiveness.
#[derive(Debug)]
pub enum NodeData {
    Token,
...
/// Visit each child node of the given node.
///
/// Calls `visitor` for each child AST node. Returns true if the visitor
/// requested to stop (by returning true from the closure).
...
// ──────────────────────────────────────────────────────────────────────
// Node accessor methods (generated)
// ──────────────────────────────────────────────────────────────────────

/// Get the text content of literal/identifier nodes.
...
/// Get the primary expression child of a node, if any.
...
/// Get the name of a declaration, if any.
...
/// Get the type child of a type node, if any.
///
/// Mirrors `Node.Type()` in Go — returns the `type` child node for type
/// nodes that have one (e.g. `ArrayType`, `ParenthesizedType`,
/// `TypeOperator`, `OptionalType`, `RestType`, `NamedTupleMember`,
/// `JSDocNullableType`, `JSDocNonNullableType`, `JSDocOptionalType`,
/// `JSDocVariadicType`, `FunctionType`, `ConstructorType`,
/// `TypePredicate`, `MappedType`).
