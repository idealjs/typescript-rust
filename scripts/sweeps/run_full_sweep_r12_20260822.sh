#!/bin/bash
# Full-sweep r12 (2026-08-22 night): verify the r11 fix-only round
# (emit-format inference for unset module, .d.ts ambient exemption).
cd /home/cqh/workspace/typescript-rust || exit 1
echo "=== full sweep r12 start: $(date) ==="
