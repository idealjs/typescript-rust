#!/bin/bash
# Full-sweep r34 (2026-08-27 evening): r33 regression cleanup — extraTypes
# port (check-any unions true branch), deferred-conditional callee default-
# constraint signatures (invocation targets), probe memoization (Go
# cachedTypes), forced-true infer scope push. Unit tests green
# (1353/985/2/15).
cd /home/cqh/workspace/typescript-rust || exit 1
echo "=== full sweep r34 start: $(date) ==="
