#!/bin/bash
# Full-sweep r21 (2026-08-24): verify TS2305 shorthand-ambient fix (Fix 1
# round-2) on the tree that r20 ran plus the post-r20 fix-only work already
# present in the working tree. Unit tests green (1344/921/15/2).
cd /home/cqh/workspace/typescript-rust || exit 1
echo "=== full sweep r21 start: $(date) ==="
