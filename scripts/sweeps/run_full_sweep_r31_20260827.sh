#!/bin/bash
# Full-sweep r31 (2026-08-27): verification round for the r30 follow-up fixes (min-arity gate, weak-type TS2559, class-expr heritage, import= export= chase, generic-alias scope shadow, cyclic return deep substitution) + cyclicTypeInstantiation cleared. Unit tests green (1353/977/2/15).
...
echo "=== full sweep r31 start: $(date) ==="
