#!/bin/bash
# Full-sweep r18 (2026-08-23): verify the harness root-selection rule
# (Go compiler_runner: noImplicitReferences / last-unit references →
# single root) + TS1453 at the types-value position.
cd /home/cqh/workspace/typescript-rust || exit 1
echo "=== full sweep r18 start: $(date) ==="
