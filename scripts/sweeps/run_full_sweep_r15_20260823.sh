#!/bin/bash
# Full-sweep r15 (2026-08-23): verify the post-r14 fix-only round
# (option-key canonicalization, node10 skip-gate removal, real JSX
# runtime resolution + preload).
cd /home/cqh/workspace/typescript-rust || exit 1
echo "=== full sweep r15 start: $(date) ==="
