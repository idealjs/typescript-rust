#!/bin/bash
# Full-sweep r17 (2026-08-23): verify the post-r16 narrowing (foreign
# free-type-param return leniency only) — expects the 4 specialized
# signature regressions cleared, D5/ExportStarAs stable.
cd /home/cqh/workspace/typescript-rust || exit 1
echo "=== full sweep r17 start: $(date) ==="
