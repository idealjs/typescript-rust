#!/bin/bash
# Full-sweep r14 (2026-08-23): verify the post-r13 fix-only round
# (declare-global merge, parser type specifier, TS2343/interop gates,
# TS2875, ambient alias chase, D1 degraded suppression, node10,
# JSX opening-first + index-signature IntrinsicElements).
cd /home/cqh/workspace/typescript-rust || exit 1
echo "=== full sweep r14 start: $(date) ==="
