#!/bin/bash
# Full-sweep r32 (2026-08-27): verification of the deep-substitution gating (return-path only) fixing the conditionalTypeContextual regression while keeping cyclic cleared. Unit tests green (1353/978/2/15).
...
echo "=== full sweep r32 start: $(date) ==="
