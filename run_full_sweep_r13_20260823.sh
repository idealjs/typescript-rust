#!/bin/bash
# Full-sweep r13 (2026-08-23): verify r12 state; baseline for the next
# fix-only round targeting the remaining compiler 3 + conformance 15 FAILs.
cd /home/cqh/workspace/typescript-rust || exit 1
echo "=== full sweep r13 start: $(date) ==="
