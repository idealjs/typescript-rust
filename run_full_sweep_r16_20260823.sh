#!/bin/bash
# Full-sweep r16 (2026-08-23): verify the post-r15 fix (ambient-module
# helper-name lookup through node locals) + the D5 inferential-callback
# unification if landed before this run starts.
cd /home/cqh/workspace/typescript-rust || exit 1
echo "=== full sweep r16 start: $(date) ==="
