#!/bin/bash
# Full-sweep r9 (2026-08-21): verify D1-partial (d1a9969) + round-13 state. NO concurrent heavy processes.
cd /home/cqh/workspace/typescript-rust || exit 1
echo "=== full sweep r9 start: $(date) ==="
