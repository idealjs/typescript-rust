#!/bin/bash
# Full-sweep r20 (2026-08-23): complete the interrupted r19 — same tree
# (post-r18 loading-chain fixes), unit tests green (1340/921/2/15).
cd /home/cqh/workspace/typescript-rust || exit 1
echo "=== full sweep r20 start: $(date) ==="
