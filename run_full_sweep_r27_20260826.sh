#!/bin/bash
# Full-sweep r27 (2026-08-26 midday): verify logical-operator branch merge
# (bindLogicalOperator semantics: keep-condition + post-RHS label), expression-
# position assignment flow, .js->.ts specifier mapping in module symbol lookup.
# Unit tests green (1350/949/2/15).
cd /home/cqh/workspace/typescript-rust || exit 1
echo "=== full sweep r27 start: $(date) ==="
