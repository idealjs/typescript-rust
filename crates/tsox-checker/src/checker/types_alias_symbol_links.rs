...
pub struct EnumMemberLinks {
    pub value: tsox_frontend::evaluator::EvalResult,
}
...
pub struct SymbolAccessibilityResult {
    ...
    pub aliases_to_make_visible: Vec<Arc<tsox_frontend::ast::Node>>,
    pub error_symbol_name: String,
    pub error_module_name: String,
    pub error_node: Option<Arc<tsox_frontend::ast::Node>>,
}
