        ...
        match node.kind {
            ...
            | SyntaxKind::ImportEqualsDeclaration => {
                ...
                let is_ambient_element = node.kind != SyntaxKind::ImportEqualsDeclaration
                    ...
                    && parent.flags.contains(tsox_frontend::ast::NodeFlags::Ambient);
            ...
            | SyntaxKind::MethodSignature => {
                ...
                let private_protected = tsox_frontend::ast::ModifierFlags::Private
                    .union(tsox_frontend::ast::ModifierFlags::Protected)
                    .bits();
