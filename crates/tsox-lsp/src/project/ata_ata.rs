...
use crate::project::ata_discover_typings::CachedTyping;
use crate::project::ata_discover_typings::TypingsInfo;
use crate::project::ata_validate_package_name::NameValidationResult;
use crate::project::ata_validate_package_name::validate_package_name;
...
pub struct TypingsInstallRequest {
    pub project_id: tsox_core::tspath::Path,
