...
fn compare_organize_imports_case_upper_first(a: &str, b: &str) -> i32 {
    compare_organize_imports_case(
        a,
        b,
        crate::ls::lsutil_user_preferences::OrganizeImportsCaseFirst::Upper,
    )
}
    ...
    for i in 0..min_len {
        ...
        if a_upper != b_upper {
            return match case_first {
                ...
                crate::ls::lsutil_user_preferences::OrganizeImportsCaseFirst::Lower => {
                    if !a_upper {
                        -1
                    } else {
                        1
                ...
                crate::ls::lsutil_user_preferences::OrganizeImportsCaseFirst::False => {
                    if a_upper {
                        1
                    } else {
                        -1
