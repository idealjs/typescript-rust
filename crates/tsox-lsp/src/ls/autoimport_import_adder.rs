...
pub struct AddToExistingState {
    ...
    pub default_import: Option<crate::ls::autoimport_fix::NewImportBinding>,
    pub named_imports: HashMap<String, crate::ls::autoimport_fix::NewImportBinding>,
}
...
pub struct ImportsCollection {
    pub default_import: Option<crate::ls::autoimport_fix::NewImportBinding>,
    pub named_imports: HashMap<String, crate::ls::autoimport_fix::NewImportBinding>,
    pub namespace_like_import: Option<crate::ls::autoimport_fix::NewImportBinding>,
...
impl ImportAdder {
    pub fn new(
        _program: &Program,
        checker: Arc<Checker>,
        _file: &tsox_frontend::ast::SourceFile,
        view: Arc<View>,
