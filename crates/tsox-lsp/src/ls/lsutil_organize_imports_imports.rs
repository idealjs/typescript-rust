use crate::ls::lsutil_organize_imports_compare_strings::cmp_compare_i32;
use crate::ls::lsutil_organize_imports_compare_strings::compare_booleans;
...
pub fn compare_module_specifiers(
    ...
    let ord = compare_booleans(
        tsox_core::tspath::is_external_module_name_relative(&name1),
        tsox_core::tspath::is_external_module_name_relative(&name2),
    );
    if ord != 0 {
        return ord;
    }
