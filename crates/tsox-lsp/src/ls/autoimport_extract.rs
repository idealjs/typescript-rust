...
use crate::ls::autoimport::INTERNAL_SYMBOL_NAME_DEFAULT;
use crate::ls::autoimport::INTERNAL_SYMBOL_NAME_EXPORT_EQUALS;
use crate::ls::autoimport::INTERNAL_SYMBOL_NAME_EXPORT_STAR;
...
pub struct SymbolExtractor {
    ...
    pub to_path: Option<Box<dyn Fn(&str) -> tsox_core::tspath::Path + Send + Sync>>,
