...
pub struct BucketState {
    pub dirty_file: tsox_core::tspath::Path,
...
pub struct RegistryBucket {
    ...
    pub paths: HashMap<tsox_core::tspath::Path, String>,
    pub package_files: HashMap<String, HashMap<tsox_core::tspath::Path, String>>,
