use crate::ls::lsutil_organize_imports_compare_strings::compare_organize_imports_natural_strings;
...
use crate::ls::lsutil_user_preferences::OrganizeImportsSort;
...
fn get_organize_imports_ordinal_string_comparer(ignore_case: bool) -> StringComparer {
    if ignore_case {
        ...
        Arc::new(|a: &str, b: &str| tsox_core::stringutil::compare_strings_case_sensitive(a, b))
    }
}
