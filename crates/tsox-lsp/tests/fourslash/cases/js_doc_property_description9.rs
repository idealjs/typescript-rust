...
function literalClass(e: typeof LiteralClass) {
    ...
    // TODO: f.VerifyQuickInfoAt(t, "literal1Class", "(index) LiteralClass[`prefix${string}`]: any", "Something g
    fourslash::verify_quick_info_at(&mut s, "literal2Class", "any", "");
    // TODO: f.VerifyQuickInfoAt(t, "literal3Class", "(index) LiteralClass[`prefix${string}` | `prefix${number}`]
}
