...
if (foo2.b/*4*/ar?.b/*5*/az.q/*6*/we) {}"#;
    let mut s = Session::new_for_test("quickInfoInOptionalChain", content);
    fourslash::verify_quick_info_at(&mut s, "1", "(property) A.arr: string[]", "");
    fourslash::verify_quick_info_at(&mut s, "2", "(property) Foo.bar: {\n    baz: string;\n}", "");
    fourslash::verify_quick_info_at(&mut s, "3", "(property) baz: string | undefined", "");
    fourslash::verify_quick_info_at(&mut s, "4", "(property) Foo2.bar?: {\n    baz: {\n        qwe: string;\n    };\n} | undefined", "");
