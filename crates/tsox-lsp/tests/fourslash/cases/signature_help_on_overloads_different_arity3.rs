...
f(/**/"#;
    ...
    // TODO: f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{Text: "f(): any", ParameterCount: 0, O
    fourslash::insert(&mut s, "x, ");
    // TODO: f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{Text: "f(s: string, b: boolean): any",
    fourslash::insert(&mut s, "x, ");
    // TODO: f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{Text: "f(s: string, b: boolean): any",
}
