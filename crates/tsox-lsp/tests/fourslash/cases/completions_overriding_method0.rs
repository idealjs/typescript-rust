...
class ISub extends IBase {
    ...
    fourslash::unsupported("VerifyCompletions"); // f.VerifyCompletions(t, "h1", &fourslash.CompletionsExpectedList{
    fourslash::unsupported("VerifyCompletions"); // f.VerifyCompletions(t, "h2", &fourslash.CompletionsExpectedList{
