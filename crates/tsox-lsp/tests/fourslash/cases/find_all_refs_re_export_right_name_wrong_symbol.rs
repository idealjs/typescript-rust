...
[|import { /*d*/[|{| "isWriteAccess": true, "isDefinition": true, "contextRangeIndex": 9 |}x|] } from "./c";|]"#;
    ...
    // TODO: f.VerifyBaselineFindAllReferences(t, "a", "b", "cFromB", "cFromA", "cUse", "d")
    ...
    // TODO: f.VerifyBaselineRename(t, nil /*preferences*/, f.Ranges()[5])
    // TODO: f.VerifyBaselineRename(t, nil /*preferences*/, f.Ranges()[10])
}
