...
writeFile/**/"#;
    ...
    // TODO: f.VerifyImportFixModuleSpecifiers(t, "", []string{"node:fs", "node:fs/promises"}, nil /*preferences*
    fourslash::go_to_file(&mut s, "/other.ts");
    // TODO: f.ReplaceLine(t, 0, "\n")
    fourslash::go_to_file(&mut s, "/index.ts");
    // TODO: f.VerifyImportFixModuleSpecifiers(t, "", []string{"fs", "fs/promises", "node:fs", "node:fs/promises"
    fourslash::go_to_file(&mut s, "/other.ts");
    // TODO: f.ReplaceLine(t, 0, "import \"node:fs/promises\";\n")
    fourslash::go_to_file(&mut s, "/index.ts");
    // TODO: f.VerifyImportFixModuleSpecifiers(t, "", []string{"node:fs", "node:fs/promises"}, nil /*preferences*
}
