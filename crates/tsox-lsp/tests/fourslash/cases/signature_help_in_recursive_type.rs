...
type Foo = Reverse<[0,/**/]>;"#;
    let mut s = Session::new_for_test("signatureHelpInRecursiveType", content);
    fourslash::go_to_marker(&mut s, "");
    // TODO: f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{Text: "Reverse<List extends any[]>"})
}
