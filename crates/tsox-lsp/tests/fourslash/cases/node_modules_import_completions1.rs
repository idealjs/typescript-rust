...
const m = import("./src//*9*/");"#;
    let mut s = Session::new_for_test("nodeModulesImportCompletions1", content);
    // TODO: f.VerifyCompletions(t, []string{"1", "3", "6", "9"}, &fourslash.CompletionsExpectedList{
    // TODO: f.VerifyCompletions(t, []string{"2", "4", "5", "7", "8"}, &fourslash.CompletionsExpectedList{
}
