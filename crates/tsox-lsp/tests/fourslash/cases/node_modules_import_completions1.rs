...
#[test]
fn node_modules_import_completions1() {
...
const m = import("./src//*9*/");"#;
    ...
    fourslash::unsupported("VerifyCompletions"); // f.VerifyCompletions(t, []string{"1", "3", "6", "9"}, &fourslash.CompletionsExpectedList{
    fourslash::unsupported("VerifyCompletions"); // f.VerifyCompletions(t, []string{"2", "4", "5", "7", "8"}, &fourslash.CompletionsExpectedList{
}
