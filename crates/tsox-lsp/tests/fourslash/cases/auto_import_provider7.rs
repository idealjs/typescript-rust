...
const b = new MyClass2/*2*/();"#;
    let mut s = Session::new_for_test("autoImportProvider7", content);
    // TODO: f.MarkTestAsStradaServer()
    fourslash::go_to_marker(&mut s, "1");
    // TODO: opts1196 := f.GetOptions()
    // TODO: opts1196.FormatCodeSettings.NewLineCharacter = "\n"
    fourslash::unsupported("Configure"); // f.Configure(t, opts1196)
