...
#[test]
fn auto_import_cross_project_node_modules() {
    let content = r#"// @Filename: /node_modules/pkg-listed/package.json
...
pkg_/**/"#;
    let mut s = Session::new_for_test("autoImportCrossProjectNodeModules", content);
    // TODO: // Open project-a's file first - this establishes that project-a imports pkg-unlisted
    fourslash::go_to_file(&mut s, "/project-a/index.ts");
    // TODO: // Now go to project-b and baseline auto-imports
