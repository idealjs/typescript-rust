...
#[test]
fn completions_import_duplicate_packages_scoped_types_and_not_types() {
...
/**/"#;
    let mut s = Session::new_for_test("completionsImport_duplicatePackages_scopedTypesAndNotTypes", content);
