...
fnNoParamsWrapped/*7*/(/*8*/);"#;
    ...
    // TODO: f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{Text: "fnWrapped(str: string, num: num
    ...
    // TODO: f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{Text: "fnVariadicWrapped(str: string, 
    fourslash::go_to_marker(&mut s, "6");
    // TODO: f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{ParameterName: "num", ParameterSpan: "
    fourslash::verify_quick_info_at(&mut s, "7", "var fnNoParamsWrapped: () => void", "");
    fourslash::go_to_marker(&mut s, "8");
    // TODO: f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{Text: "fnNoParamsWrapped(): void", Par
}
