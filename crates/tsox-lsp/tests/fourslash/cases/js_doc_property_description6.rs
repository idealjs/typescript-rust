...
function literal1Example(e: Literal1Example) {
    ...
    // TODO: f.VerifyQuickInfoAt(t, "literal1", "(index) Literal1Example[`prefix${string}`]: string | number", ""
    fourslash::verify_quick_info_at(&mut s, "literal2", "any", "");
    // TODO: f.VerifyQuickInfoAt(t, "literal3", "(index) Literal1Example[`prefix${string}` | `prefix${number}`]: 
}
