...
var /*4*/r4 = _./*41*/all([<any>true], _.identity);"#;
    ...
    fourslash::verify_quick_info_at(
        &mut s,
        "11",
        "(method) Underscore.Static.all<string | number | boolean>(list: (string | number | boolean)[], iterator?: Underscore.Iterator<string | number | boolean, boolean>, context?: any): string | number | boolean",
        "",
    );
    ...
    fourslash::verify_quick_info_at(
        &mut s,
        "21",
        "(method) Underscore.Static.all<boolean>(list: boolean[], iterator?: Underscore.Iterator<boolean, boolean>, context?: any): boolean",
        "",
    );
    ...
    fourslash::verify_quick_info_at(
        &mut s,
        "31",
        "(method) Underscore.Static.all<any>(list: any[], iterator?: Underscore.Iterator<any, boolean>, context?: any): any",
        "",
    );
