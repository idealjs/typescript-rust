...
#[ignore = "generator: // The module specifier path should still work though."]
#[test]
fn go_to_source_nested_node_modules() {
    // TODO: // When a .d.ts file is inside nested node_modules (more than one /node_modules/
    // TODO: // than trying to resolve, since the package name extraction may be incorrect.
    // TODO: // The module specifier path should still work though.
...
inner/*usage*/();"#;
    let mut s = Session::new_for_test("goToSourceNestedNodeModules", content);
