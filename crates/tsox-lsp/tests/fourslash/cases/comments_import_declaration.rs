...
var new/*9*/Var = new extMod.m1.m2./*10*/c();"#;
    ...
    fourslash::unsupported("VerifyQuickInfoAt"); // f.VerifyQuickInfoAt(t, "2", "namespace m1", "NamespaceComment")
    fourslash::unsupported("VerifyQuickInfoAt"); // f.VerifyQuickInfoAt(t, "3", "import extMod = require(\"./commentsImportDeclaration_file0\")", "Impor
    ...
    fourslash::unsupported("VerifyQuickInfoAt"); // f.VerifyQuickInfoAt(t, "8q", "function extMod.m1.fooExport(): number", "exported function")
    fourslash::unsupported("VerifyQuickInfoAt"); // f.VerifyQuickInfoAt(t, "9", "var newVar: extMod.m1.m2.c", "")
