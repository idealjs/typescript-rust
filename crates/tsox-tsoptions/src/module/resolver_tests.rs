...
fn implied_format_from_package_json_chain() {
    ...
    assert_eq!(
        crate::tsoptions::implied_node_format_of_file("/a/b/x.ts", &read),
        ModuleKind::ESNext
    );
    assert_eq!(
        crate::tsoptions::implied_node_format_of_file("/a/b/x.mts", &read),
        ModuleKind::ESNext
    );
    assert_eq!(
        crate::tsoptions::implied_node_format_of_file("/a/b/x.cts", &read),
        ModuleKind::CommonJS
    );

    assert_eq!(
        crate::tsoptions::implied_node_format_of_file("/a/node_modules/x.ts", &read),
        ModuleKind::ESNext
    );
}
