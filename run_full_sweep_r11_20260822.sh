#!/bin/bash
# Full-sweep r11 (2026-08-22): verify the r10 fix-only round (TS2314→error
# linkage, 2441/1216/2725 gating, triple-slash resolution-mode plumbing).
# NO concurrent heavy processes during the run.
cd /home/cqh/workspace/typescript-rust || exit 1
echo "=== full sweep r11 start: $(date) ==="
