#!/bin/bash
# Full-sweep r29 (2026-08-26 evening): verification round for the 8 recorded-issue
# fixes (typeRoots config base / ambient-first module resolution / globals from
# scripts only / alias+MappedType containers / union dedup / nullish widening /
# lexical declaring context / reexport alias chase). Unit tests green (1353/958/2/15).
cd /home/cqh/workspace/typescript-rust || exit 1
echo "=== full sweep r29 start: $(date) ==="
