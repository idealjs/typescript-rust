#!/bin/bash
# Full-sweep r23 (2026-08-25 evening): verify Fix 1b (module_member_lookup
# query-side redo) + binder file-symbol declarations fix + the 01:41
# inference.rs contra-optimism revert. Unit tests green (1350/921/2/15).
cd /home/cqh/workspace/typescript-rust || exit 1
echo "=== full sweep r23 start: $(date) ==="
